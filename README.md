...
Мне очень интересно изучать новые технологии🩶.
Увлекаюсь программированием в свободное время⏰. 
...
- 🚀 Интересуюсь: Frontend и Backend разработкой, низкоуровнивым программированием. 
- 🌱 Сейчас изучаю: TypeScript, Docker, git/githab
- 💬 С удовольствием общаюсь на любую тему, связанную с программирование и технологиями  
- ⚡ Моë мнение: «тратьть свое время нужно в первую очередь для общества и только потом на себя»
